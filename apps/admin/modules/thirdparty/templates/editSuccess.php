...
<table cellspacing="0" cellpadding="0" class="AdminNavBar">
 <tr>
  ...
  <td width="30%" class="drkgrylnk" align="center"><div class="Title">Edit 3rd Party </div></td>
   ...
   <table cellpadding="8" cellspacing="0" align="right">
    <tr align="center">
     <!--<td width="57" class="LinkImg" ><a href="#" title="Edit"><?php image_tag("admin/Icon_Save.gif", array("alt"=>"Save","title"=>"Save","border"=>"0")) ?><br />
      Save </a></td>-->
     <td width="57" class="LinkImg" ><a href="<?php echo url_for('thirdparty/index') ?>"><?php echo image_tag("admin/Icon_Cancel.gif", array("alt"=>"Cancel","title"=>"Cancel","border"=>"0")) ?><br />
      Cancel </a></td>
    </tr>
   </table>
  </td>
         ...
         <table cellspacing="0" cellpadding="0" align="center" width="100%">
          <!--<tr>
           ...
           <td width="90%" class="ContentBtmDotLn">
            <div style="float:left;" class="Title">Edit 3rd Party </div>           
           </td>
          </tr>-->
          <tr valign="top">
