   ...
   <table cellpadding="8" cellspacing="0" align="right">
    <tr align="center">
     <!--<td width="57" class="LinkImg" ><a href="#" title="Edit"><?php image_tag("admin/Icon_Save.gif", array("alt"=>"Save","title"=>"Save","border"=>"0")) ?><br />
      Save </a></td>-->
     <td width="57" class="LinkImg" ><a href="<?php echo url_for('case/index') ?>"><?php echo image_tag("admin/Icon_Cancel.gif", array("alt"=>"Cancel","title"=>"Cancel","border"=>"0")) ?><br />
      Cancel </a></td>
    </tr>
   </table>
  </td>
			 ...
			 <td colspan="2" class="ListAreaPad">
			  <table width="65%" cellspacing="1" cellpadding="1" class="brd1" align="center">
			   ...
			   <tr>
				  ...
				  <td width="90%" class="fldrowbg">
				   <?php echo sfConfig::get('app_currency').$case->getActualAmount();?>
				  </td>
				</tr>
			   ...
			   <tr>
				  ...
				  <td width="90%" class="fldrowbg">
				   <?php echo sfConfig::get('app_currency').$case->getCommisionActual();?>
				  </td>
				</tr>
			   ...
			   <tr>
				  ...
				  <td width="90%" class="fldrowbg">
				   <?php echo sfConfig::get('app_currency').$case->getProcessingFees();?>
				  </td>
				</tr>
			   <tr>
				  <td width="10%" class="fldrowbg"><b>Under Payment Adjustment:</b></td>
				  <td width="90%" class="fldrowbg">
				   <?php if ($case->getUnderpayadjustment() != '') {echo sfConfig::get('app_currency').$case->getUnderpayadjustment();}else { echo "---"; }?>
				  </td>
				</tr>
			   <tr>
				  <td width="10%" class="fldrowbg"><b>Payable Amount To Customer:</b></td>
				  <td width="90%" class="fldrowbg">
				   <?php echo sfConfig::get('app_currency').$case->getPayableAmount();?>
				  </td>
				</tr>
			   <tr>
				  <td width="10%" class="fldrowbg"><b>Paid Amount:</b></td>
				  <td width="90%" class="fldrowbg">
				   <?php if ($case->getPaidAmount() != '')echo sfConfig::get('app_currency').$case->getPaidAmount();else echo "---";?>
				  </td>
				</tr>
			   <tr>
				  <td width="10%" class="fldrowbg"><b>Remain To Pay Amount:</b></td>
				  <td width="90%" class="fldrowbg">
				   <?php if ($case->getRemainToPay() != '')echo sfConfig::get('app_currency').$case->getRemainToPay();else echo "---";?>
				  </td>
				</tr>
			   <tr>
				  <td width="10%" class="fldrowbg"><b>Received Amount From 3rd Party:</b></td>
				  <td width="90%" class="fldrowbg">
				   <?php if ($case->getReceivedAmount() != '')echo sfConfig::get('app_currency').$case->getReceivedAmount();else echo '---';?>
				  </td>
				</tr>
			   <tr>
				  <td width="10%" class="fldrowbg"><b>Remain To Receive:</b></td>
				  <td width="90%" class="fldrowbg">
				   <?php if ($case->getRemainToReceive() != '')echo sfConfig::get('app_currency').$case->getRemainToReceive();else echo '---';?>
				  </td>
				</tr>
			   <tr>
				  <td width="10%" class="fldrowbg"><b>Difference Amount:</b></td>
				  <td width="90%" class="fldrowbg">
				   <?php if ($case->getDifferenceAmount() != '')echo sfConfig::get('app_currency').$case->getDifferenceAmount();else echo '---';?>
				  </td>
				</tr>
				  <td width="10%" class="fldrowbg"><b>3rd Party Bills Submitted:</b></td>
				  <td width="90%" class="fldrowbg">
				   <?php if ($case->getThirdPartyBillsSubmitted() != '')echo $case->getThirdPartyBillsSubmitted();else echo '---';?>
				  </td>
				</tr>
			   <!--<tr>
