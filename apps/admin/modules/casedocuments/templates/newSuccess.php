					...
					<td width="34%" align="right" class="AdminBreadCrumb">
						<table cellpadding="8" cellspacing="0" align="right">
							<tr align="center">
								...
								Save </a></td>-->
								<?php if($bFlag == 1): ?>
										<td width="57" class="LinkImg" ><a href="<?php echo url_for('casedocuments/index?caseId='.$caseId.'&bFlag=1') ?>"><?php echo image_tag("admin/Icon_Cancel.gif", array("alt"=>"Cancel","title"=>"Cancel","border"=>"0")) ?><br />
										Cancel </a></td>
								<?php else:?>
										<td width="57" class="LinkImg" ><a href="<?php echo url_for('casedocuments/index?caseId='.$caseId) ?>"><?php echo image_tag("admin/Icon_Cancel.gif", array("alt"=>"Cancel","title"=>"Cancel","border"=>"0")) ?><br />
										Cancel </a></td>
								<?php endif; ?>
							</tr>
						</table>
												...
												<table cellspacing="0" cellpadding="0" align="center" class="ContentTable">
													<tr>
														...
														<td width="90%" class="ContentBtmDotLn">
															<div style="float:left;" class="Title">Add case documents ( CaseNo.: <?php echo $caseNo;?> )</div>
														</td>
													</tr>
													<tr valign="top">
