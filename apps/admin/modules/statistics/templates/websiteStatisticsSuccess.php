									...
									<tr>
										<td align="center" valign="top">
											<table width="98%" cellspacing="1" cellpadding="1" class="PageListHeading">
												<tr>
													<td align="left" valign="middle"><strong>Website Statistics</strong></td>
												</tr>
											</table>
											<table align="left">
												<tr>
													<td>
														<?php echo $form["websiteStatistics"]->render(array("onChange"=>"setWebId();")); ?>
														<input type="hidden" value="" id="hiddenWebId">
													</td>
												</tr>
											</table>
										</td>
...
function setWebId()
{
	$("#hiddenWebId").val($("#search_statistics_websiteStatistics").val());
	BtnDate('1', 'DAY','btn_1');
}
