									...
									<tr>
										<td align="center" valign="top">
											<table width="98%" cellspacing="1" cellpadding="1" class="PageListHeading">
												<tr>
													<td align="left" valign="middle"><strong>Profile Statistics</strong></td>
												</tr>
											</table>
											<table align="left">
												<tr>
...
$(function() {
    ...
    $( "#autoName" ).autocomplete({
        source: "<?php url_for('statistics/profileStatistics') ?>",
        minLength: 2,
...
function BtnDate(buttonDay,buttonDayType,btnid)
{
    $.ajax({
		    ...
		    'data': {BtnDay:buttonDay ,DayType:buttonDayType, customerId:$("#hiddenCustomerId").val()},
