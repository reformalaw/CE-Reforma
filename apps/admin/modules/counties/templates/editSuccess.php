		...
		<td width="100%">
			<table cellspacing="0" cellpadding="0" class="AdminNavBar">
				<tr>
					...
					<td width="30%" class="drkgrylnk" align="center"><div class="Title">Edit County </div></td>
					<td width="35%" align="right" class="AdminBreadCrumb">
						<table cellpadding="8" cellspacing="0" align="right">
							<tr align="center">
								<td width="57" class="LinkImg" ><a href="<?php echo url_for('counties/index') ?>"><?php echo image_tag("admin/Icon_Cancel.gif", array("alt"=>"Cancel","title"=>"Cancel","border"=>"0")) ?><br />
								Cancel </a></td>
							</tr>
						</table>
					</td>
