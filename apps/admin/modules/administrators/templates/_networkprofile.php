...
<tr valign="top">
 <td colspan="2" class="ListAreaPad">
  <form action="<?php echo url_for('administrators/networkprofile') ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?> id="networkProfileFrm" name="networkProfileFrm">
  <?php if (!$form->getObject()->isNew()): ?><input type="hidden" name="sf_method" value="put" /><?php endif; ?>

  <table width="98%" cellspacing="1" cellpadding="1" class="EditFAQ CaseEditForm" align="center">
    <!--start Code added for solve the issue 470-->
	<?php if ($form['Location']->hasError()): ?>            
		...
		<?php endif; ?>
	<!--END Code added for solve the issue 470-->
    <tr>
