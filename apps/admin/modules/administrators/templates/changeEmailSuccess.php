			...
			<table width="100%" cellspacing="0" cellpadding="0">
				<tr>
					<td width="150" align="left" valign="top" class="LeftMenu">
						...
						<?php include_partial('administrators/personalProfileMenu');?>
						<!--END VERTICAL MENU-->
					</td>
								...
								<table width="100%" cellspacing="10" cellpadding="0">
									<tr>
										<td align="center" valign="top">
											<table width="98%" cellspacing="1" cellpadding="1" class="PageListHeading">
												<tr>
													<td align="left" valign="middle"><strong>Edit Email</strong></td>
												</tr>
											</table>
										</td>
									</tr>
									<tr>
										<td align="center" valign="top" width="98%">
											<?php include_partial('changeEmail', array('form' => $form,'ssEmail'=>$ssEmail)) ?>
										</td>
									</tr>
								</table>
							</td>
...
<table cellspacing="0" cellpadding="0" class="AdminNavBar">
 <tr>
  ...
  <td width="30%" class="drkgrylnk" align="center"><div class="Title">Edit Email</div></td>
