		...
		<!-- Bread Crumb Start -->
			<table cellspacing="0" cellpadding="0" class="AdminNavBar">
				<tr>
					...
					<td width="30%" class="drkgrylnk" align="center"><div class="Title">View Forum</div></td>
												...
												<table width="100%" cellspacing="0" cellpadding="0" align="center" class="">
													<!--<tr>
														...
														<td width="90%" class="ContentBtmDotLn">
															<div style="float:left;" class="Title">View Forum </div>
														</td>
													</tr>-->
													<tr valign="top">
														<td colspan="2" class="dot"></td>
													</tr>
													<?php include_partial('forumsViewForm', array('form' => $form)) ?>
												</table>
											</td>
										</tr>
									</table>
