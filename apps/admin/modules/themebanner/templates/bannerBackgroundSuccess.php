								...
								<table width="100%" cellspacing="10" cellpadding="0">
									<tr>
										<td align="center" valign="top">
											<table width="98%" cellspacing="1" cellpadding="1" class="PageListHeading">
												<tr>
													<td align="left" valign="middle"><strong>Edit Banner Backgroud </strong></td>
												</tr>
											</table>
										</td>
									</tr>
									...
									<tr>
										<td align="center" valign="top" width="98%">
											<?php include_partial('formBannerBackground', array('form' => $form, 'backgroundImageName'=>$backgroundImageName, 'backgroundImages'=>$backgroundImages,'ssSiteUrl'=>$ssSiteUrl)) ?>
										</td>
									</tr>
                                    <tr>
