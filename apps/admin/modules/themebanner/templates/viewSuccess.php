								...
								<table width="100%" cellspacing="10" cellpadding="0">
									<tr>
										<td align="center" valign="top">
											<table width="98%" cellspacing="1" cellpadding="1" class="PageListHeading">
												<tr>
													<td align="left" valign="middle"><strong>View Banner </strong></td>
									...
									<tr>
										<td align="center" valign="top" width="98%">
											<?php include_partial('themeBanerView', array('form' => $form,'bannerImagePath'=>$bannerImagePath,'totalBannerTitle'=>$totalBannerTitle)) ?>
										</td>
									</tr>
		...
		<!-- Bread Crumb Start -->
			<!--<table cellspacing="0" cellpadding="0" class="AdminNavBar">
				<tr>
					...
					<td width="30%" class="drkgrylnk" align="center"><div class="Title">View banner </div></td>
					<td width="35%" align="right" class="AdminBreadCrumb">
						<table cellpadding="8" cellspacing="0" align="right">
							<tr align="center">-->
								...
								Save </a></td>-->
								<!--<td width="57" class="LinkImg" ><a href="<?php //echo url_for('themebanner/index') ?>"><?php //echo image_tag("admin/Icon_Cancel.gif", array("alt"=>"Cancel","title"=>"Cancel","border"=>"0")) ?><br />
								Cancel </a></td>-->
							<!--</tr>
						</table>
					</td>
												...
												<table cellspacing="0" cellpadding="0" align="center" width="100%">-->
													<!--<tr>
														...
														<td width="90%" class="ContentBtmDotLn">
															<div style="float:left;" class="Title">View banner </div>
														</td>
													</tr>-->
													<!--<tr valign="top">
														<td colspan="2" class="dot"></td>
													</tr>
													<?php //include_partial('themeBanerView', array('form' => $form,'bannerImagePath'=>$bannerImagePath)) ?>
												</table>
											</td>
										</tr>
									</table>
