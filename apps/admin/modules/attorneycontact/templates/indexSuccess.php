...
<tr>
  <td align="left" valign="top"><table width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td width="150" align="left" valign="top" class="LeftMenu"><!--START VERTICAL MENU-->
        ...
        <td align="center" valign="top" class="CashDetails"><table width="96%" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="left" valign="top" class="WebsiteDetails"><table width="100%" cellspacing="10" cellpadding="0">
              	<tr>
                  ...
                  <tr>
                    <td align="center" class="ContentPad"><table width="98%" cellspacing="1" cellpadding="0" class="CaseEditForm" id ="r">
                        <tr class="fldbg">
                          <td class="titleTd" width="20%">FieldType</td>
                        ...
                        <tr>
                          <td valign="middle" class="fldrowlightbg" ><select id="fieldType" onChange="checkFieldType();"    style="width:175px;">
                          ...
                          <td valign="middle" class="fldrowlightbg"><textarea name="Options" id="options" disabled="disabled" cols="30" rows="2"></textarea>
                          </td>
                          <td valign="middle" class="fldrowlightbg"><input type="checkbox" name="Required" id="required" onClick="checkRequired();">
                          </td>
                          <td id="btn" valign="middle" class="fldrowlightbg"><p id="modeAdd" >
                              <input type="button" value="Add" class="CommonButton" id="blue_button" name="submit">
                            </p>
                            <p id="modeEdit" style="display:none">
                              <input type="button" value="Save" class="CommonButton" id="edit_btn" name="submit">
                  ...
                  <tr>
                    <td align="center" valign="top"><table width="98%" cellspacing="1" cellpadding="1" class="PageListHeading">
                        <tr>
                          <td align="left" valign="middle"><strong>Attorney Contact Page Field List</strong></td>
                        </tr>
                      </table></td>
                  </tr>
                  <tr>
                    <td align="center" valign="top"><table width="100%" cellspacing="0" cellpadding="0">
                        <tr>
                          <td class="ContentPad"><table width="100%" cellspacing="0" cellpadding="0" align="center" class="">
                              <tr valign="top">
                                <td colspan="2" class="dot"></td>
                              </tr>
                              <?php include_partial('default/message'); ?>
                              <tr align="center" valign="top" style="display:none" id="ajaxMsg">
                                <td colspan="2" class="ListAreaPad"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                              ...
                              <tr align="center" valign="top" style="display:none" id="ajaxMsgEdit">
                                <td colspan="2" class="ListAreaPad"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                      <td class="success" align="center"><a href="#" id="msg">Field Updated Successfully</a></td>
                                  </table></td>
                              </tr>
                              <?php
													$varExtra = '';
                              ...
                              <tr align="center" valign="top">
                                <td colspan="2" class="ListAreaPad"><table width="98%" cellspacing="1" cellpadding="1" class="brd1">
                                    <tr class="fldbg">
                                      <td class="border-right border-left border-top" width="20%" align="center" ><?php include_partial('default/ordering',array('title'=>'Label','ordering'=>false,"siteURL"=>'faq/counceledgeList','alias'=>'Label','orderBy'=>$orderBy,'orderType'=>$orderType, 'extra_vars'=>$varExtra));?>
                                      </td>
                                      <td class="border-right border-left border-top" width="20%" align="center"><?php include_partial('default/ordering',array('title'=>'FieldType','ordering'=>false,"siteURL"=>'faq/counceledgeList','alias'=>'FieldType','orderBy'=>$orderBy,'orderType'=>$orderType, 'extra_vars'=>$varExtra));?>
                                      </td>
                                      <td class="border-right border-left border-top" width="20%" align="center"><?php include_partial('default/ordering',array('title'=>'Options','ordering'=>false,"siteURL"=>'faq/counceledgeList','alias'=>'Options','orderBy'=>$orderBy,'orderType'=>$orderType, 'extra_vars'=>$varExtra));?>
                                      </td>
                                      <td class="border-right border-top"  align="center"><?php include_partial('default/ordering',array('title'=>'Required','ordering'=>false,"siteURL"=>'faq/counceledgeList','alias'=>'Required','orderBy'=>$orderBy,'orderType'=>$orderType, 'extra_vars'=>$varExtra));?>
                                      </td>
                                    ...
                                    <tr>
                                      <td colspan="5" style="padding:0px;"><div id="contentLeft">
                                          <ul id="listRecord">
                                            <?php foreach ($pager as $custRecord): ?>
                                            <li  id="recordsArray_<?php echo $custRecord->getId(); ?>">
                                              <table cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                  <td width="20%" class="fldrowbg border-right border-left"  align="left" valign="top" id="label_<?php echo $custRecord->getId(); ?>"><?php echo $custRecord->getLabel() ?> </td>
                                                  <td width="20%" class="fldrowbg border-right border-left"  align="left" valign="top" id="fieldType_<?php echo $custRecord->getId(); ?>"><?php echo $custRecord->getFieldType() ?> </td>
                                                  <td width="20%" class="fldrowbg border-right border-left"  align="left" valign="top" id="options_<?php echo $custRecord->getId(); ?>"><?php if($custRecord->getOptions() != '' ) 
																								echo $custRecord->getOptions();
																								else
																								        echo '---';   ?>
                                                  </td>
                                                  <td width="20%" class="fldrowbg border-right" align="center" valign="top" id="required_<?php echo $custRecord->getId(); ?>"><?php echo $custRecord->getRequired() ?> </td>
                                                  <td width="20%" class="fldrowbg border-right" align="center" id="action"><a href="#" id="editRecord" onClick="editRecord(<?php echo $custRecord->getId()?>);"> <?php echo image_tag('admin/edit-cases-icon.png',array(
																																	'border'=>'0','alt'=>'Edit','title'=>'Edit','width'=>'24px','height'=>'25px'))?> </a> <a href="<?php echo url_for('attorneycontact/deleteRecord?id='.$custRecord->getId())?>" id="deleteRecord"> <?php echo image_tag('admin/delete-cases-icon.png',array(
                                    ...
                                    <tr class="fldbg" id="noRecord">
                                      <td class="errormss" id="norecord" colspan="5">No items found.</td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                    </tr>
...
function checkFieldType() {
    ...
    if(value=='DropDown' ||  value=='CheckBox' || value=='Radio' ){
        //$('#options').attr('readonly', false);//line added and change by jaydip dodiya cause client issue 406
            $('#options').attr('disabled', false);//line added and change by jaydip dodiya cause client issue 406
    }else{
        $('#options').attr('value', '');//line added and change by jaydip dodiya cause client issue 406
        //$('#options').attr('readonly', true);//line added and change by jaydip dodiya cause client issue 406
...
$(document).ready(function()
{
    ...
    $(function()
    {
        $("#contentLeft ul").sortable({ opacity: 0.6, cursor: 'move', update: function()
        {
            ...
            $.post("<?php echo url_for("attorneycontact/globelOrdering"); ?>", order, function(theResponse){});
        }
        });
    });
    ...
    $("#edit_btn").click(function() {
        ...
        $.ajax( {
            type: "POST",
            url: "<?php echo url_for('attorneycontact/saveData'); ?>",
