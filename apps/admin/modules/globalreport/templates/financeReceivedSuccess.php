         ...
         <table cellspacing="0" cellpadding="0" align="center" class="ContentTable">
          <tr>
           ...
           <td width="90%" class="ContentBtmDotLn">
            <div style="float:left;" class="Title">Finance Report - Total amount received from 3rd Pary
            <br>
          ...
          <tr valign="top" >
            ...
            <form action="<?php echo url_for('globalreport/financeReceived') ?>" method="post" onsubmit="return validateFinance();">
                          ...
                          <table width="100%" border="0" cellspacing="3" cellpadding="0" >
                            <tr>
                              <td width="60%"><table width="" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="left" ><b><span>Select Payment Received Date <?php #echo $searchForm['FromDate']->renderLabel(); ?></span></b></td>

                                  </tr>
                                  <tr>

                                    <td align="left"  valign="top">
                                        <?php echo $searchForm['FromDate']->render(); 
                                        echo "&nbsp;To&nbsp;";
                                    ...
                                    <td align="left" class="radioBtn" valign="top"><span class="bluButton"> 
                                        ...
                                        <?php echo tag('input', array('name' => 'clear', 'type' => 'reset', 'id' => 'clear', 'class' => 'grayButton', 'value' => 'Clear', "onclick"=>'window.location="'.url_for('globalreport/financeReceived').'"')); ?> </span> 
                                      </td>
                                  </tr>
          ...
          <tr align="center" valign="top">
           <td colspan="2" class="ListAreaPad">
            ...
            <?php if($pager->getnbResults() > 0){?>
             <tr class="fldbg">
                <td align="center" width="25%"><b>3rd Party Name</b></td>
                <td align="center" width="25%"><b>Received Amount</b></td>                            
             </tr>              
               <?php foreach ($pager->getResults() as $cases):?>
             <tr>
                <td class="fldrowbg" align="left" valign="top"><?php echo $cases->getTpname() ;?></td>
                <td class="fldrowbg" align="left" valign="top">$<?php echo $cases->getReceivedamount() ?></td>
          ...
          <tr align="right" valign="top">
           <td colspan="2" class="ListAreaPad">                     
              ...
              ?>
               <?php include_partial("default/pagging",array('pager' => $pager, '','strUrl' => 'globalreport/financeReceived', 'varExtra' => $varExtra));?>
           </td>
          </tr>
         </table>
        </td>
