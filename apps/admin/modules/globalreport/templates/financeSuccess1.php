         ...
         <table cellspacing="0" cellpadding="0" align="center" class="ContentTable">
          <tr>
           ...
           <td width="90%" class="ContentBtmDotLn">
            <div style="float:left;" class="Title">Finance Report - Total amount paid to Customers
            <br>
                              ...
                              <td width="60%"><table width="" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr>
                                    ...
                                    <td align="left" class="radioBtn" valign="top"><span class="bluButton"> 
                                        ...
                                        <?php echo tag('input', array('name' => 'clear', 'type' => 'reset', 'id' => 'clear', 'class' => 'grayButton', 'value' => 'Clear', "onclick"=>'window.location="'.url_for('globalreport/finance').'"')); ?> </span> 
                                      </td>
                                  </tr>
           ...
           <td colspan="2" class="ListAreaPad">
            ...
            <?php if($pager->getnbResults() > 0){?>
             <tr class="fldbg">
                ...
                <td align="center" width="25%"><b>Paid Amount</b></td>                            
             </tr>              
             <?php $i=1; ?>
             ...
             <tr class="<?php echo $class;?>">
                ...
                <td class="fldrowbg" align="left" valign="top">$<?php echo $cases->getPaidamount() ?></td>
