						...
						<td width="34%" align="right" class="AdminBreadCrumb">
							<table cellpadding="8" cellspacing="0" align="right">
								<tr align="center">
									...
									Save </a></td>-->
									<td width="57" class="LinkImg" ><a href="<?php echo url_for('userswebsite/index') ?>"><?php echo image_tag("admin/Icon_Cancel.gif", array("alt"=>"Cancel","title"=>"Cancel","border"=>"0")) ?><br />
									Cancel </a></td>
								</tr>
							</table>
						</td>
												...
												<table cellspacing="0" cellpadding="0" align="center" class="ContentTable">
													<tr>
														...
														<td width="90%" class="ContentBtmDotLn">
															<div style="float:left;" class="Title">View Users Website </div>
														</td>
													</tr>
													<tr valign="top">
