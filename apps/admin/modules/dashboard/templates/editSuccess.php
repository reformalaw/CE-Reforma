   ...
   <table cellpadding="8" cellspacing="0" align="right">
    <tr align="center">
     <!--<td width="57" class="LinkImg" ><a href="#" title="Edit"><?php image_tag("admin/Icon_Save.gif", array("alt"=>"Save","title"=>"Save","border"=>"0")) ?><br />
      Save </a></td>-->
     <td width="57" class="LinkImg" ><a href="<?php echo url_for('dashboard/index?customerId='.$snUserId) ?>"><?php echo image_tag("admin/Icon_Cancel.gif", array("alt"=>"Cancel","title"=>"Cancel","border"=>"0")) ?><br />
      Cancel </a></td>
    </tr>
   </table>
  </td>
    ...
    <tr>
     <td class="MaintblPadding">
      <table width="100%" cellspacing="0" cellpadding="0">
       <tr>
        <td class="ContentPad">
         <table cellspacing="0" cellpadding="0" align="center" class="" width="100%">
          <!--<tr>
          ...
          <tr>
            <td valign="middle" align="center" class="CasesListUserName" colspan="2">Edit Customer </td>
          </tr>
          <tr valign="top">
           <td colspan="2" class="dot"></td>
          </tr>
          <?php include_partial('form', array('form' => $form,'webTem'=>$webTem,'weburlTem'=>$weburlTem,'netWork'=>$netWork,'displayWebBox'=>$displayWebBox,'flag'=>$flag)) ?>
         </table>
        </td>
       </tr>
      </table>
