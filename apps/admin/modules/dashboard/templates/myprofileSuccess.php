								...
								<table width="100%" cellspacing="10" cellpadding="0" style="border-top: 1px solid #E7E7E7;">
									<tr>
										<td align="center" valign="top">
											<table width="98%" cellspacing="1" cellpadding="1" class="PageListHeading">
												<tr>
													<td align="left" valign="middle"><strong>Edit Personal Profile</strong></td>
												</tr>
											</table>
										</td>
									</tr>
									...
									<tr>
										<td align="center" valign="top" width="98%">
											<?php include_partial('myprofile', array('form' => $form,'ssEmail'=>$ssEmail,'ssUsername'=>$ssUsername,'viewImageName'=>$viewImageName,'snId'=>$snId)) ?>
										</td>
									</tr>
								</table>
							</td>
...
<table cellspacing="0" cellpadding="0" class="AdminNavBar">
 <tr>
  ...
  <td width="30%" class="drkgrylnk" align="center"><div class="Title">Edit Profile</div></td>
   ...
   <table cellpadding="8" cellspacing="0" align="right">
    <tr align="center">
     <!--<td width="57" class="LinkImg" ><a href="#" title="Edit"><?php image_tag("admin/Icon_Save.gif", array("alt"=>"Save","title"=>"Save","border"=>"0")) ?><br />
      Save </a></td>-->
     <td width="57" class="LinkImg" ><a href="<?php echo url_for('default/index') ?>"><?php echo image_tag("admin/Icon_Cancel.gif", array("alt"=>"Cancel","title"=>"Cancel","border"=>"0")) ?><br />
      Cancel </a></td>
    </tr>
   </table>
  </td>
         ...
         <table width="100%" cellspacing="0" cellpadding="0" align="center" class="">
          <!--<tr>
           ...
           <td width="90%" class="ContentBtmDotLn">
            <div style="float:left;" class="Title">My profile </div>           
           </td>
          </tr>-->
          <tr valign="top">
