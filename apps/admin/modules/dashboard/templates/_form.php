          ...
          <?php }*/ ?>
           <tr>
                <td align="center" valign="top" colspan="2">
                	<table width="65%" cellspacing="1" cellpadding="1" class="PageListHeading">
                    	<tr>
...
<tr valign="top">
 <td colspan="2" class="">
  <form action="<?php echo url_for('dashboard/'.($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId().'&customerId='.$form->getObject()->getId()."&flag=".$flag : '')) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?> id="userRegistration" name="userRegistration">
  <?php if (!$form->getObject()->isNew()): ?><input type="hidden" name="sf_method" value="put" /><?php endif; ?>
  <table width="65%" cellspacing="1" cellpadding="1" class="CaseEditForm" align="center">
      <tr class="fldbg">
                        <td align="left" valign="middle"><strong>Customers Details</strong></td>
                        <td align="left" valign="middle"></td>
                      </tr>
   <tr>
      ...
      <td width="68%" class="fldrowlightbg">
       <?php echo $form['FirstName']->render(array('style'=>'width:250px;')) ?>
    ...
    <tr>
      ...
      <td width="68%" class="fldrowlightbg">
       <?php echo $form['LastName']->render(array('style'=>'width:250px;')) ?>
    ...
    <tr>
      ...
      <td width="68%" class="fldrowlightbg">
       <?php echo $form['Email']->render(array('style'=>'width:250px;')) ?>
    ...
    <tr>
      ...
      <td width="68%" class="fldrowlightbg">
       <?php echo $form['Confirm_Email']->render(array('style'=>'width:250px;')) ?>
    ...
    <tr>
      ...
      <td width="68%" class="fldrowlightbg">
       <?php echo $form['Username']->render(array('style'=>'width:250px;')) ?>
    ...
    */ ?>
    ...
    <tr>
      ...
      <td width="68%" class="fldrowlightbg">
       <?php echo $form['Password']->render(array('style'=>'width:250px;')) ?>
    ...
    <tr>
      ...
      <td width="68%" class="fldrowlightbg">
       <?php echo $form['Address1']->render(array('style'=>'width:250px;')) ?>
    ...
    <tr>
      ...
      <td width="68%" class="fldrowlightbg">
       <?php echo $form['Address2']->render(array('style'=>'width:250px;')) ?>
    ...
    <tr>
      ...
      <td width="68%" class="fldrowlightbg">
       <?php echo $form['Phone']->render(array('style'=>'width:256px;')) ?>
    ...
    <tr>
      ...
      <td width="68%" class="fldrowlightbg">
       <?php echo $form['City']->render(array('style'=>'width:250px;')) ?>
    ...
    <tr>
      ...
      <td width="68%" class="fldrowlightbg">
       <?php echo $form['StateId']->render(array('style'=>'width:256px;')) ?>
    ...
    <tr>
      ...
      <td width="68%" class="fldrowlightbg">
       <?php echo $form['Zip']->render(array('style'=>'width:250px;')) ?>
       <?php if ($form['Zip']->hasError()): ?>            
            <div class="errormsgs"><?php echo $form['Zip']->getError()?></div>            
       <?php endif; ?>      </td>
    </tr>
    <tr>
      <td width="26%" class="fldrowbg"><b><?php echo "Subscribe For "//$form['BillingSubscription']->renderLabel() ?>:</b></td>
      <td width="68%" class="fldrowlightbg">
    ...
    <tr id="weburldiv" style="<?php echo $tempVal; ?>">
      ...
      <td width="68%" class="fldrowlightbg">
       <?php echo $form['Weburl']->render(array('style'=>'width:250px;','value'=>$weburlTem,'onblur'=>'return checkUrl(this.value)')) ?>&nbsp;<span id="mesg">(<b>Ex :</b>&nbsp;www.counseledge.com)</span>
   ...
   <tr class="fldbg">
   <td height="33" align="left" class="fldrowbg">&nbsp;</td>
...
function generateRow(value,id) {
    if(value == "on"){
        ...
        /*if( $('#admin_users_customers_Weburl').val().length != 0 ) {
...
jQuery().ready(function() {
    $("#admin_users_customers_Confirm_Email").val($("#admin_users_customers_Email").val());
	...
	jQuery("#userRegistration").validate({
		...
		messages: {
		    ...
		    "admin_users_customers[Email]": {
		      ...
		      maxlength:  "E-mail address cannot be longer than 45 characters."
		    },
		    "admin_users_customers[Username]": {
		      required:   "This field is required.",
		      minlength:  "Username must be at least 3 characters long.",
		      maxlength:  "Username cannot be longer than 45 characters."
		    },
		    "admin_users_customers[Password]": {
		      required:   "This field is required.",
