									...
									<tr>
										<td align="center" valign="top">
											<table width="98%" cellspacing="1" cellpadding="1" class="PageListHeading">
												<tr>
													<td align="left" valign="middle"><strong>Edit Practice Area <?php #echo $sf_user->getAttribute('websiteUrl'); ?></strong></td>
												</tr>
											</table>
										</td>
									</tr>
												...
												<table cellspacing="0" cellpadding="0" align="center" class="ContentTable">
													<tr>
														...
														<td width="90%" class="ContentBtmDotLn">
															<div style="float:left;" class="Title">Edit Practice Area -  <?php //echo $sf_user->getAttribute('websiteUrl'); ?></div>
														</td>
													</tr>
													<tr valign="top">
