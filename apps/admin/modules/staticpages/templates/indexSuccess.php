									...
									<tr>
										<td align="center" valign="top">
											<table width="98%" cellspacing="1" cellpadding="1" class="PageListHeading">
												<tr>
													<td align="left" valign="middle"><strong>Counsel Edge CMS Pages List</strong></td>
												</tr>
											</table>
										</td>
									</tr>
													...
													<td colspan="2" class="ListAreaPad">
														<table width="100%" cellspacing="1" cellpadding="1" class="brd1">
															...
															<tr class="<?php echo $class;?>">
																	<td class="fldrowbg" align="left" valign="top"><?php echo link_to($cms_pages->getTitle(),'staticpages/edit?id='.$cms_pages->getId().'&temp=CE'); //$cms_pages->getTitle() ?></td>
																	...
																	<td class="fldrowbg" align="center">
																		<?php echo link_to(image_tag('admin/edit-cases-icon.png',array('width'=>'24px','height'=>'25px','border'=>'0','alt'=>'Delete','title'=>'Edit')),'staticpages/edit?id='.$cms_pages->getId().'&temp=CE'); ?>
																		...
																		<?php else: ?>
																			<?php echo link_to(image_tag('admin/delete-cases-icon.png',array('width'=>'24px','height'=>'25px','border'=>'0','alt'=>'Delete','title'=>'Delete', 'OnClick'=>"return deleteConfirmation();")),'staticpages/delete?id='.$cms_pages->getId().'&temp=CE'); ?>
																		<?php endif;?>
																	</td>
															</tr>
															<?php endforeach; ?>    
...
<!--<table cellspacing="0" cellpadding="0" class="AdminNavBar">
 <tr>
  ...
  <td width="30%" class="drkgrylnk" align="center"><div class="Title">Counceledge CMS Pages List</div></td>
         ...
         <table cellspacing="0" cellpadding="0" align="center" width="100%">
          <!--<tr>
           ...
           <td width="90%" class="ContentBtmDotLn">
            <div style="float:left;" class="Title">Counceledge CMS Pages List</div>
           ...
           <td colspan="2" class="ListAreaPad">
            ...
            <?php if($pager->getnbResults() > 0){?>
             ...
             <tr class="<?php echo $class;?>">
                    ...
                    <td class="fldrowbg" align="center">
						<?php echo link_to(image_tag('admin/edit-cases-icon.png',array('width'=>'24px','height'=>'25px','border'=>'0','alt'=>'Delete','title'=>'Edit')),'staticpages/edit?id='.$cms_pages->getId().'&temp=CE'); ?>
                        <!--<a href="<?php //echo url_for('staticpages/edit?id='.$cms_pages->getId().'&temp=CE')?>"><?php //echo image_tag('admin/edit-icon.png',array('border'=>'0','alt'=>'Delete','title'=>'Edit'))?></a>&nbsp;-->
                    </td>
             </tr>
             <?php endforeach; ?>    
             <?php } else { ?> 
