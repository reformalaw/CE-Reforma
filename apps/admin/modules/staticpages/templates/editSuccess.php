								...
								<table width="100%" cellspacing="10" cellpadding="0">
											...
											<table width="98%" cellspacing="1" cellpadding="1" class="PageListHeading">
												<tr>
													<td align="left" valign="middle">
														<?php if($sf_request->getParameter('temp') == "CE"): ?>
															<strong>Edit Counsel Edge CMS page </strong>
														<?php elseif($sf_request->getParameter('temp') == "LG"): ?>
															<strong>Edit Legalgrip CMS page </strong>
														<?php endif; ?>
													</td>
												</tr>
											</table>
									...
									<tr>
										<td align="center" valign="top" width="98%">
											<?php include_partial('form', array('form' => $form,'cmspage'=>$cmspage,'websitedetail'=>$websitedetail,'displaySlugValue'=>$displaySlugValue,'type'=>$type)) ?>
										</td>
									</tr>
								</table>
							</td>
