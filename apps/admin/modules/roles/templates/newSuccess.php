...
<table cellspacing="0" cellpadding="0" class="AdminNavBar">
 <tr>
  ...
  <td width="30%" class="drkgrylnk" align="center"><div class="Title">Add Roles </div></td>
         ...
         <table cellspacing="0" cellpadding="0" align="center" width="100%">
          <!--<tr>
           ...
           <td width="90%" class="ContentBtmDotLn">
            <div style="float:left;" class="Title">Add Roles </div>           
           </td>
          </tr>-->
          <tr valign="top">
           <td colspan="2" class="dot"></td>
          </tr>
          <?php include_partial('form', array('form' => $form,'arrCategory'=>$arrCategory,'arrCheckBoxPermission'=>array())) ?>
         </table>
        </td>
       </tr>
      </table>
