						...
						<td width="34%" align="right" class="AdminBreadCrumb">
							<table cellpadding="8" cellspacing="0" align="right">
								<tr align="center">-->
									...
									Save </a></td>-->
									<!--<td width="57" class="LinkImg" ><a href="<?php //echo url_for('personalWebsiteFAQs/index') ?>"><?php //echo image_tag("admin/Icon_Cancel.gif", array("alt"=>"Cancel","title"=>"Cancel","border"=>"0")) ?><br />
									Cancel </a></td>
								</tr>
							</table>
						</td>
												...
												<table cellspacing="0" cellpadding="0" align="center" class="ContentTable">
													<!--<tr>
														...
														<td width="90%" class="ContentBtmDotLn">
															<div style="float:left;" class="Title">View Personal Website FAQs </div>
														</td>
													</tr>-->
													<tr valign="top">
														<td colspan="2" class="dot"></td>
													</tr>
													<?php include_partial('viewPersonalWeb', array('form' => $form)) ?>
												</table>
											</td>
										</tr>
									</table>
