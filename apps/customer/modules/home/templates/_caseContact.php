...
<form action="<?php echo url_for('home/index') ?>" method="post" name="casecontact" onsubmit="return validateForm()">
    ...
    <p><?php echo $contactForm['name']->render(array( 'onblur' => "if(this.value=='') this.value=this.defaultValue;", 'onfocus' =>"if(this.value==this.defaultValue) this.value='';", 'value'=> "Name"));?></p>
    
    <p><?php echo $contactForm['email']->render(array( 'onblur' => "if(this.value=='') this.value=this.defaultValue;", 'onfocus' =>"if(this.value==this.defaultValue) this.value='';", 'value'=> "Email"));?></p>
    
    <p><?php echo $contactForm['phone']->render(array( 'onblur' => "if(this.value=='') this.value=this.defaultValue;", 'onfocus' =>"if(this.value==this.defaultValue) this.value='';", 'value'=> "Phone"));?></p>
    
    <p><?php echo $contactForm['message']->render( array('onfocus' => "if(this.value==this.defaultValue) this.value='';", 'onblur' => "if(this.value=='') this.value=this.defaultValue;", 'value' => 'Brief Message'));?> </p>
    <p><input name="submit" type="submit" value="Submit your Message" /></p>
