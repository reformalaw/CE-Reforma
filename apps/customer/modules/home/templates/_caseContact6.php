...
<?php if($sf_user->hasFlash('succMsg')) { ?>
    <p align="left" style="color:green;float:left; position: absolute; margin: -29px 0 0 180px;"><?php echo $sf_user->getFlash('succMsg');?></p>
<?php }?>

<form action="<?php echo url_for('home/index') ?>" method="post" name="casecontact" onsubmit="return validateForm()">
	<ul>
    <li>Name :<p><?php echo $contactForm['name']->render(array( 'onblur' => "if(this.value=='') this.value=this.defaultValue;", 'onfocus' =>"if(this.value==this.defaultValue) this.value='';", 'value'=> ""));?></p></li>

    <li>Email :<p><?php echo $contactForm['email']->render(array( 'onblur' => "if(this.value=='') this.value=this.defaultValue;", 'onfocus' =>"if(this.value==this.defaultValue) this.value='';", 'value'=> ""));?></p></li>

    <li>Phone :<p><?php echo $contactForm['phone']->render(array( 'onblur' => "if(this.value=='') this.value=this.defaultValue;", 'onfocus' =>"if(this.value==this.defaultValue) this.value='';", 'value'=> ""));?></p></li>

    <li><?php echo $contactForm['message']->render( array('onfocus' => "if(this.value==this.defaultValue) this.value='';", 'onblur' => "if(this.value=='') this.value=this.defaultValue;", 'value' => 'Brief Message'));?> </li>
