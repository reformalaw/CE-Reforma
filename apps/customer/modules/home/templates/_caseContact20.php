<div class="quick-contact">
	<h2>Tell us About <span>your Case</span></h2>
	<div class="quick-form">
		<?php if($sf_user->hasFlash('succMsg')) { ?>
			<p align="left" style="color:green;float:left; position: absolute; margin: 12px 0 0 220px;"><?php echo $sf_user->getFlash('succMsg');?></p>
		<?php }?>
		...
		<form action="<?php echo url_for('home/index') ?>" method="post" name="casecontact" onsubmit="return validateForm()">
			...
			<input name="" type="submit" value="Send" class="send-btn"/>
		</form>
	</div>
</div>
