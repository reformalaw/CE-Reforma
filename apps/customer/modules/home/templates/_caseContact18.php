...
<?php if($sf_user->hasFlash('succMsg')) { ?>
    <p align="left" style="color:green;float:left; position: absolute; margin:-30px 0 0 168px;"><?php echo $sf_user->getFlash('succMsg');?></p>
<?php }?>
...
<form action="<?php echo url_for('home/index') ?>" method="post" name="casecontact" onsubmit="return validateForm()">
	...
	<div class="quick-contact-btn"><input name="" type="submit" value="Send" /></div>
</form>
