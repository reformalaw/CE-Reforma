...
/**
 * Counties filter form base class.
 *
 * @package    counceledge
 * @subpackage filter
 ...
 */
abstract class BaseCountiesFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'StateId'        => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('CountiesStates'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'StateId'        => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('CountiesStates'), 'column' => 'Id')),
    ...
    $this->widgetSchema->setNameFormat('counties_filters[%s]');
