...
/**
 * UsersWebsite filter form base class.
 *
 * @package    counceledge
 * @subpackage filter
 ...
 */
abstract class BaseUsersWebsiteFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'UserId'         => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('UsersWebsiteUsers'), 'add_empty' => true)),
      'ThemeId'        => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('UsersWebsiteTheme'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'UserId'         => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('UsersWebsiteUsers'), 'column' => 'Id')),
      'ThemeId'        => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('UsersWebsiteTheme'), 'column' => 'Id')),
    ...
    $this->widgetSchema->setNameFormat('users_website_filters[%s]');
