...
/**
 * PermissionCategory filter form base class.
 *
 * @package    counceledge
 * @subpackage filter
 ...
 */
abstract class BasePermissionCategoryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('permission_category_filters[%s]');
