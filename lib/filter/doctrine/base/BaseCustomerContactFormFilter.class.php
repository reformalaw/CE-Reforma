...
/**
 * CustomerContact filter form base class.
 *
 * @package    counceledge
 * @subpackage filter
 ...
 */
abstract class BaseCustomerContactFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'UserId'         => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('CustomerContactUsers'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      'UserId'         => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('CustomerContactUsers'), 'column' => 'Id')),
    ...
    $this->widgetSchema->setNameFormat('customer_contact_filters[%s]');
