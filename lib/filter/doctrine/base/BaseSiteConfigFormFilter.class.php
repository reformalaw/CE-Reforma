...
/**
 * SiteConfig filter form base class.
 *
 * @package    counceledge
 * @subpackage filter
 ...
 */
abstract class BaseSiteConfigFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'ConfigValue'    => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      'ConfigValue'    => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('site_config_filters[%s]');
