...
/**
 * AttorneyContact form base class.
 *
 * @method AttorneyContact getObject() Returns the current form's model object
 *
 * @package    counceledge
 * @subpackage form
 ...
 */
abstract class BaseAttorneyContactForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'Id'             => new sfWidgetFormInputHidden(),
      'UserId'         => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('AttorneyContactUsers'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'UserId'         => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('AttorneyContactUsers'))),
    ...
    $this->widgetSchema->setNameFormat('attorney_contact[%s]');
