 ...
 */
class PersonalCMSPagesForm extends BaseCMSPagesForm
{
    ...
    public function configure()
    {
        ...
        if ($this->getOption('home')){
            ...
            'Title'             => new sfValidatorString(array('required' => true,'trim'=>true,'min_length' => 3,'max_length'=>255),array('required'=>'This field is required.','min_length'=>'Title must be at least 3 characters long.','max_length'=>'Title cannot be longer than 255 characters.')),
