  protected function processForm(sfWebRequest $request, sfForm $form)
  {
    ...
    if ($form->isValid())
    {
      ...
      if($request->isMethod(sfRequest::PUT))
        $this->getUser()->setFlash('succMsg', "<?php echo $this->getSingularName()?> information updated successfully");
      else 
        $this->getUser()->setFlash('succMsg', "New <?php echo $this->getSingularName()?> added Successfully");
