...
function smart_resize_image( $file, $width = 0, $height = 0, $output = 'file', $proportional = false, $delete_original = true, $use_linux_commands = false )
  {
    if ( $height <= 0 && $width <= 0 ) {
      return false;
    }
	...
	smart_resize_image($s_image,$max_width,$max_height,'browser',true); 
?>
